...
from connections.exceptions.cannot_delete_basic_elements_exceptions import (
    CanNotDeleteNodesException,
    CanNotDeleteEdgesException)
from connections.exceptions.object_already_exists_exceptions import (
    NodeAlreadyExistsException,
    EdgeAlreadyExistsException)
from connections.exceptions.object_isnot_exists_exceptions import (
    NodeIsNotExistsException,
    CoupleIsNotExistsException,
    EdgeIsNotExistsException)
from connections.exceptions.validation_exceptions import (
